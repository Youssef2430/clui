...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "GLUI";
...
export const APP_DISPLAY_NAME =
  ...
  formatAppDisplayName({ baseName: APP_BASE_NAME, stageLabel: import.meta.env.DEV ? "Dev" : "latest" });
