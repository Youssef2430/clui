...
/**
 * The skew a user can act on: the connected server runs an older GLUI than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same GLUI version.",
  };
}
