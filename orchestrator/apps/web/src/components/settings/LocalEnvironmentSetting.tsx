  ...
  return (
    <>
      <SettingsRow
        ...
        description={
          enabled
            ? "Run agents on this computer. Turn off to use GLUI only with remote environments."
      ...
      >
        <AlertDialogPopup>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {enabled
                ? "GLUI will restart without running a server on this computer. Any agents and terminals running here will stop, and other devices will no longer be able to connect to this computer. Your projects, history, and remote environments are unaffected."
                : "GLUI will restart and start running a server on this computer again."}
            </AlertDialogDescription>
          </AlertDialogHeader>
