  ...
  return (
    <div className="space-y-4 text-sm">
      ...
      {result ? (
        ...
        <>
          <p className="text-muted-foreground">
            Allow GLUI to read your desktop settings. You'll review any changes here before
            saving.
          </p>
          <Button
          ...
          {!supported ? (
            <p className="text-xs text-muted-foreground">
              Update GLUI to finish setting up your shortcut.
            </p>
          ) : null}
        </>
      )}
      ...
      {state.shortcutActionRegistered === false && state.shortcutMessage ? (
        <p role="status" className="text-muted-foreground">
          {state.shortcutPending
            ...
            : "Restart GLUI to finish connecting your shortcut."}
        </p>
      ) : null}
      <details className="text-xs text-muted-foreground">
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="space-y-1">
            ...
            {niri ? <p>GLUI also reads any files included by this file.</p> : null}
          ...
          <p>
            Turn capture off in GLUI to stop it. Remove the shortcut from {desktop} to free up
            the keys.
          </p>
