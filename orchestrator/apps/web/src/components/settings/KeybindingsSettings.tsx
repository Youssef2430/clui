...
function UnknownWhenVariableWarning({
  ...
  return (
    <WarningTooltipIcon label={label} focusable={focusable} className="size-4.5">
      GLUI does not recognize this condition yet. It can still be saved, but it may not match
...
function BrowserKeybindingNotice() {
  return (
    <div className="flex items-center gap-2 px-3 py-2.5 text-[12px] leading-[1.45] text-muted-foreground sm:px-4">
      ...
      <span>
        Some shortcuts may be claimed by the browser before GLUI sees them. Use the desktop app
...
export function KeybindingsSettingsPanel() {
  ...
  // shortcut change reaches each machine the user runs GLUI on.
