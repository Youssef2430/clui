    ...
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <WizardHeader
          title="Set up GLUI"
          identity={
            <div className="flex items-baseline gap-1.5" role="img" aria-label="GLUI">
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Keep GLUI running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start GLUI first, or run <code className="font-mono">npx t3 serve</code>. Add{" "}
