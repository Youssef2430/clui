...
describe("AcpAdapterV2", () => {
  ...
  it.live("refreshes ACP prompt instructions when the interaction mode changes", () =>
    Effect.gen(function* () {
      ...
      assert.include(firstDefault.prompt, "GLUI interaction mode: Default");
      assert.include(firstDefault.prompt, "GLUI collaborative browser");
      assert.include(firstDefault.prompt, "GLUI orchestration");
      assert.notInclude(
      ...
      assert.include(firstPlan.prompt, "GLUI interaction mode: Plan");
      ...
      assert.include(restoredBuild.prompt, "GLUI interaction mode: Default");
      assert.include(
