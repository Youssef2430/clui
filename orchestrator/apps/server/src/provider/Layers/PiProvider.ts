    ...
    if (!piSettings.enabled) {
      return buildServerProvider({
        ...
        probe: {
          ...
          status: "warning",
          auth: { status: "unknown" },
          message: "Pi is disabled in GLUI settings.",
        },
      });
    }
    return buildServerProvider({
  ...
  if (version === null) {
    return buildServerProvider({
      ...
      probe: {
        ...
        status: "error",
        auth: { status: "unknown" },
        message: `GLUI could not determine the Pi version. Pi ${MINIMUM_PI_VERSION} or newer is required.`,
      },
    });
  }
  ...
  if (Exit.isFailure(discoveryExit)) {
    ...
    return buildServerProvider({
      ...
      probe: {
        ...
        auth: { status: "unknown" },
        message:
          "Pi is available, but GLUI could not refresh its models and commands. The live session will retry startup.",
      },
    });
  }
