 ...
 * (`bin/claude.exe`, or `cli.js` for older package versions). Other platforms
 * also resolve bare commands before handing them to the SDK, whose native
 * executable check can otherwise interpret them relative to the project.
 */
