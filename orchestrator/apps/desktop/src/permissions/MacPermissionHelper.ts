...
<header>↑ Drag GLUI into the list above</header>
<button id="app" draggable="true" aria-label="Drag GLUI to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">GLUI</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged GLUI icon is missing.");
