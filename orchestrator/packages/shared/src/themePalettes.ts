export const BUILT_IN_THEME_IDS = ["burgundy", "tidal", "ember", "iris", "t3-chat", "grove", "ocean"] as const;

/** The standard GLUI palette, kept separate from the optional built-in theme library. */
...
/**
 * The palette GLUI wears with no theme installed, captured from the app's
...
/** GLUI's product palettes share every semantic role with the orchestration UI. */
function gluiColors(appearance: ThemeAppearance, values: readonly string[]): ThemeColors {
  const [canvas, surface, accent, rose, text, muted, border] = values as [string,string,string,string,string,string,string];
  const dark = appearance === "dark";
  return {
    ...(dark ? T3_CODE_DARK_THEME_COLORS : T3_CODE_LIGHT_THEME_COLORS),
    canvas, chrome: canvas, toolbar: canvas, toolbarForeground: text, toolbarBorder: border,
    toolbarControl: surface, toolbarControlForeground: text, toolbarControlHover: border,
    surface, surfaceRaised: canvas, surfaceOverlay: canvas, text, textMuted: muted,
    border, input: border, focus: accent, accent, accentForeground: dark ? canvas : "#FFF9F2",
    secondary: surface, secondaryForeground: text, muted: surface, mutedForeground: muted,
    placeholder: muted, secondaryLabel: muted, iconMuted: muted,
    update: rose, updateForeground: accent, updateSurface: surface,
    accentSurface: surface, accentSurfaceForeground: accent,
    messageSurface: surface, messageForeground: text, messageAction: accent,
    messageActionForeground: dark ? canvas : "#FFF9F2", messageActionHover: dark ? rose : accent,
    codeBackground: canvas, codeForeground: text,
    sidebar: surface, sidebarForeground: text, sidebarMutedForeground: muted,
    sidebarControlSurface: canvas, sidebarRowHover: canvas, sidebarRowActive: canvas,
    sidebarRowSelected: canvas, sidebarBorder: border,
    terminalBackground: canvas, terminalForeground: text, terminalCursor: accent,
    terminalSelection: border, terminalScrollbar: border, terminalScrollbarHover: muted,
  };
}

export const BURGUNDY_THEME: ThemeDefinition = {
  id: "burgundy", label: "Burgundy", appearance: "light",
  colors: gluiColors("light", ["#FFF9F2", "#F3E6D5", "#800020", "#D45060", "#2F1920", "#775D64", "#DFCCBC"]),
  variants: { dark: gluiColors("dark", ["#29171D", "#39222B", "#F39EAD", "#D45060", "#FFF9F2", "#C5A8B1", "#603C48"]) },
};

export const TIDAL_THEME: ThemeDefinition = {
  id: "tidal", label: "Tidal", appearance: "light",
  colors: gluiColors("light", ["#F1F5EC", "#E3EBDF", "#215E4B", "#59A67F", "#183C31", "#516A60", "#CEDBD0"]),
  variants: { dark: gluiColors("dark", ["#102925", "#1B3933", "#A9EDC7", "#67B997", "#ECF6EF", "#A7BCB1", "#30544A"]) },
};

export const EMBER_THEME: ThemeDefinition = {
  id: "ember", label: "Ember", appearance: "light",
  colors: gluiColors("light", ["#FBF1E7", "#F2DECC", "#964725", "#CD784C", "#3D251D", "#806252", "#DBC4B1"]),
  variants: { dark: gluiColors("dark", ["#2A211F", "#3B2E29", "#FFB38A", "#DA865C", "#FFF2E8", "#C6AD9E", "#5B4338"]) },
};

export const IRIS_THEME: ThemeDefinition = {
  id: "iris", label: "Iris", appearance: "light",
  colors: gluiColors("light", ["#F1F0FA", "#E3DFF0", "#6352A3", "#9B84D6", "#302846", "#736885", "#CEC6E0"]),
  variants: { dark: gluiColors("dark", ["#202337", "#2F334B", "#C5BAFF", "#9F91E6", "#F5F2FF", "#B3B9D4", "#484E70"]) },
};
