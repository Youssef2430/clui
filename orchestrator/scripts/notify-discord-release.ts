  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new GLUI prerelease is available for nightly testers."
          : "A new GLUI latest release is available.",
...
).pipe(Command.withDescription("Post a GLUI release announcement to Discord."));
