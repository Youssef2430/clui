# Clui — Command Line User Interface for Claude Code
...
- **Requires Claude Code CLI** — Clui is a UI layer, not a standalone AI client. You need an authenticated `claude` CLI.
